# 🖇 Ontologies Alignment and Merging

## <mark style="color:purple;">WIDOCO Ontology Documentation</mark>

{% embed url="https://krke-project.github.io/index-en.html" %}

<details>

<summary><mark style="color:blue;"><strong>Turtle Serialization</strong></mark></summary>

{% code title="Van_Gogh_Ontology.ttl" overflow="wrap" %}
```turtle
...
{% file src="../.gitbook/assets/Van_Gogh_Ontology.ttl" %}
